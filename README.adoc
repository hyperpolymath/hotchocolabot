...
[![CI](https://img.shields.io/github/actions/workflow/status/Hyperpolymath/hotchocolabot/rust_ci.yml?style=flat-square)](https://github.com/Hyperpolymath/hotchocolabot/actions)

Part of UAL Creative Communities' Postdisciplinary Mechatronics Group (MechCC)

[NOTE]
====
Canonical home for HotChocolaBot is this repo: `https://github.com/hyperpolymath/hotchocolabot`.
The old `gitbot-fleet` nested path is a mirror, not the source of truth.
====
